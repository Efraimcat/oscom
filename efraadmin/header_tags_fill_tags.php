                  ...
                  while ($categories_tags = tep_db_fetch_array($categories_tags_query)) {
                      ...
                      if ($updateDB) {
                          ...
                          if (! empty($categories_tags['categories_name'])) {
                              ...
                              $fillTagsErrors['categories'][] = '<a class="htc_Link" href="' . tep_href_link('categories.php', 'cID=' . $categories_tags['categories_id']) . '&action=edit_category">' . sprintf(ERROR_FILL_TAGS_CATEGORIES, $categories_tags['categories_id'],$languages[$idPos]['id'] . ' ( '. $languages[$idPos]['name'] . ' ) ' ) . '</a>';
                          }  
                      }           
                  }
              }
                ...
                while ($manufacturers_tags = tep_db_fetch_array($manufacturers_tags_query)) {
                    ...
                    if ($updateDB) {          
                        ...
                        if (! empty($manufacturers_tags['manufacturers_name'])) { 
                            ...
                            $fillTagsErrors['manufacturers'][] = '<a class="htc_Link" href="' . tep_href_link('manufacturers.php', 'mID=' . $manufacturers_tags['manufacturers_id']) . '&action=edit_category">' . sprintf(ERROR_FILL_TAGS_MANUFACTURERS, $manufacturers_tags['manufacturers_id'],$languages[$idPos]['id'] . ' ( ' . $languages[$idPos]['name'] . ' ) ' ) . '</a>';
                        }    
                    }
                }
            }
                  ...
                  while ($products_tags = tep_db_fetch_array($products_tags_query)) {
                    ...
                    if ($updateDB) {
                      ...
                      if (! empty($products_tags['products_name'])) {            
                          ...
                          $fillTagsErrors['products'][] = '<a class="htc_Link" href="' . tep_href_link('categories.php', 'pID=' . $products_tags['products_id']) . '&action=new_product">' . sprintf(ERROR_FILL_TAGS_PRODUCTS, $products_tags['products_id'],$languages[$idPos]['id'] . ' ( '. $languages[$idPos]['name'] . ' ) ' ) . '</a>';
                      }  
                  } 
              }
          }
...
<table border="0" width="100%" cellspacing="2" cellpadding="2">
  <tr>
    ...
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
     ...
     <tr>
      <td align="right"><?php echo tep_draw_form('header_tags', 'header_tags_fill_tags.php', '', 'post') . tep_draw_hidden_field('action', 'process'); ?></td>
       <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
       </tr>
