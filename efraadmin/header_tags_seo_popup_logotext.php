...
*/
  ...
  if (isset($_POST['action']) && $_POST['action'] == 'add_logotext')
  {
    ...
    $pageTags_query = tep_db_query("select * from headertags where page_name like '" . $_POST['pagename'] . "' and language_id = '" . (int)$_POST['languageid'] . "'");
    $pageTags = tep_db_fetch_array($pageTags_query);
    
    if (tep_db_num_rows($pageTags_query))
    {
       tep_db_query("update headertags set page_logo_1 = '" . $logotext_1 . "', page_logo_2 = '" . $logotext_2 . "', page_logo_3 = '" . $logotext_3 . "', page_logo_4 = '" . $logotext_4 . "' where page_name like '" . $_POST['pagename'] . "' and language_id = '" . (int)$_POST['languageid'] . "'"); 
    }
  }
  else
  {
    $pageTags_query = tep_db_query("select * from headertags where page_name like '" . $_GET['pagename'] . "' and language_id = '" . (int)$_GET['languageid'] . "' LIMIT 1");
    $pageTags = tep_db_fetch_array($pageTags_query);
  }
  ...
  <tr>
   <td align="center"><table border="0" width="50%">
    <tr>
     ...
     <td class="smallText" align="center"><INPUT type="image" src="<?php echo 'includes/languages/' . $language . '/images/buttons/button_update.gif'; ?>" NAME="extra_logotext"></td>
