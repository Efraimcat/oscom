<?php
$contactHelp = file_get_contents('includes/languages/' . $language . '/headertags_seo/headertags_seo_footer.txt');
...
<div class="section"><span class="subHeading">Breadcrumb Model Override</span> - This option will cause the breadcrumb
to use the products model number instead of the product name. This is useful for sites that have products with long product names
or where the module number if more important for SEO.</div>
  
<div class="section"><span class="subHeading">ByPass New Pages Check</span> - Some versions of oscommerce, especially those changed with
...
<div class="section"><span class="subHeading">Enable Additional Words</span> - When this option is enabled, if additional words
have been entered for a product and the module for the product page has been installed, those words will be displayed on the 
product page. This can be very helpful with the ranking of a product where various names are used for that product. 
</div>
  
<div class="section"><span class="subHeading"></span>Enable Additional Words</span> - This option allows additional
keywords to be shown on the product page. This is useful for products that may have more than one keyword. For example, if
your shop sells computers, you may list a computer by the manufacturer but also have an additional keyword of PC or MAC. There 
is a place to add the additional words on the product edit page. They should be listed as a comma-separated list. The code 
will handle the display. The words will not display if this option is not enabled.
</div>
...
<div class="section"><span class="subHeading">Enable HTML Editor for Category Descriptions</span> - If the selected editor is installed and
  ...
  <div class="section"><span class="subHeading">Enable HTML Editor for Manufacturer Description</span> - If the selected editor is installed and
  this option is set, it will be used for the manufacturer descriptions.</div>
