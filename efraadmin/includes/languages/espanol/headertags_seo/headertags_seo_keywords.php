...
<div style="padding-top:10px;">By clicking on the "show IPs" link, which is below the keyword in the list, the IP\'s that were used when 
doing the search are shown. This is helpful to see if it is multiple people searched or all by the same person.
</div>
