...
define('BOX_HEADING_HEADERTAGS_TAGCLOUD', 'Búsquedas Populares');
define('TEXT_SEE_MORE', 'ver más');
define('TEXT_SEE_MORE_FULL', 'ver más acerca de %s');
define('HTS_OG_AVAILABLE_STOCK', 'Existencias disponibles');
define('HTS_OG_PRICE', 'Precio');
/*** End Header Tags SEO ***/
