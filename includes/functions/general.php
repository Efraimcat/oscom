...
//    global $customer_zone_id, $customer_country_id;
	global $customer_zone_id, $customer_country_id, $customer_nif, $customer_company;
//	EBG
...
//	EBG 29/05/17	Si el cliente tiene definido un NIF y su pais no es España (195), aplicamos 0% de IVA
//	EBG 06/06/17	CAMBIO POR: Si el cliente tiene definido LA EMPRESA y su pais no es España (195), aplicamos 0% de IVA
//	if ( strlen($customer_nif)  > 0 && $customer_country_id != 195 ){
	if ( strlen($customer_company)  > 0 && $customer_country_id != 195 ){
		$tax_rates[$class_id][$country_id][$zone_id]['rate'] = 0;
	}	
//	EBG
...
//	EBG 02/06/17
//
//	Si el cliente no tiene definido un NIF y su pais es España (195), no aplicar el IRPF
//
	if ( strlen($customer_nif)  < 1 && $customer_country_id == 195 ){
		$tax_rates[$class_id][$country_id][$zone_id]['rate'] = 21;
	}	
//	EBG
...
//	EBG 29/05/17	  
	global $customer_zone_id, $customer_country_id, $customer_nif;
//	EBG	  
    static $tax_rates = array();
...
//	EBG	02/06/17
//	Si es español y no tiene NIF, no mostrar el texto del IRPF (-9 carácteres)  
		if ( strlen($customer_nif) < 1 && $customer_country_id == 195 ){
			$tax_description = substr($tax_description, 0, -12);
		}	
//	EBG		
